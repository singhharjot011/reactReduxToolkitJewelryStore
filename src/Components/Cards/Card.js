...
export default function Card({
  ...
  return (
    <div className="flex flex-col p-2 w-72 h-[450px] cursor-pointer shadow-lg shadow-biege">
    ...
    active:bg-biege/60"
      ...
      <div className="self-center p-2 h-1/5 text-xl flex flex-col text-center">
